...
def section_pending():
    ...
    features = [
        ...
        ("H",  "Pinecone semantic memory",                   False, "Replaces keyword search with meaning search"),
        ("H",  "Research Reports Flutter screen",            False, "Not built yet — data is in Firestore"),
